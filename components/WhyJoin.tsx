      ...
      <div className="relative container mx-auto px-6">
        ...
        >
          {benefits.map((benefit, index) => (
            <motion.div 
              key={index} 
              className="bg-white/30 backdrop-blur-lg p-6 shadow-lg rounded-2xl flex items-start space-x-4 transition-transform duration-300 hover:scale-105 border border-white/40"
